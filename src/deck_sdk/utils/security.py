...
def get_security_from_env(security: Any, security_class: Any) -> Optional[BaseModel]:
    ...
    if os.getenv("DECKSDK_CLIENT_ID"):
        security_dict["client_id"] = os.getenv("DECKSDK_CLIENT_ID")

    if os.getenv("DECKSDK_SECRET"):
        security_dict["secret"] = os.getenv("DECKSDK_SECRET")
